...
from arborax.lowlevel.beagle_cffi import BeagleLikelihoodCalculator
...
def python_scaled_likelihood(tip_data, operations, edge_map, Q, pi, pattern_weights):
    ...
    for op in operations:
        ...
        cumulative_scale = local_log_scaler + node_cumulative_scales[child1] + node_cumulative_scales[child2]
...
def test_large_tree_scaling():
    ...
    py_logL, py_partials, py_cum_scales = python_scaled_likelihood(tip_data, ops, edge_map, Q, pi, np.array([1.0]))
